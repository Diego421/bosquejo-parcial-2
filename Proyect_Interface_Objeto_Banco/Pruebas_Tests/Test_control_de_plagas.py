...
import unittest
from Modelo.Control_de_plagas import Control_de_plagas

class TestControlPlagas(unittest.TestCase):
    def test_crear_control_plagas(self):
        producto = Control_de_plagas("Insecticida", 10000, "ICA123", 15, 7)
    ...
    def test_frecuencia_invalida(self):
        with self.assertRaises(ValueError):
            Control_de_plagas("Insecticida", 10000, "ICA123", -5, 7)
